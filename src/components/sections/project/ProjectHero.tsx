...
export default function ProjectHero({ title, location, status, year, heroImageId }: ProjectHeroProps) {
  return (
    <section className="relative flex min-h-screen items-end pb-24">
      ...
      <GridWrapper className="relative z-10">
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <span className={cn('text-label border px-3 py-1', statusColor[status])}>
            {statusLabel[status]}
          </span>
